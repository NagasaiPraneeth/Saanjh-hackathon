      ...
      <div className="flex-grow p-4">
        {showPatients ? (
          ...
          filteredReports.map((report, index) => (
            <div key={index} className="flex items-center gap-4 bg-[#f8fafb] px-4 min-h-[72px] py-2 mb-3 transition-all duration-300 ease-in-out hover:bg-[#e8edf3] cursor-pointer rounded-xl">
              <div className="bg-[#e8edf3] text-[#4f7396] font-bold rounded-full h-14 w-14 flex items-center justify-center">
              ...
              <div className="flex flex-col justify-center flex-grow">
                ...
                <p className="text-[#4f7396] text-sm font-normal leading-normal line-clamp-2">
                  Date: {formatDate(report.date)}, Status: {report.isVerified ? "Verified" : "Unverified"}
                </p>
              </div>
            </div>
          ))
